...
class _WritePostDialogState extends State<WritePostDialog> {
  ...
  ///
  /// [newLanguage]에는 `C++`과 같은 언어 이름이 들어간다. 언어 이름에 따라 코드에디터의 문법을 바꾸어 준다.
        ...
        children: [
          Row(
            children: [
              ...
              const SubmitButton(buttonTitle: '언어에 맞는 문법 적용'),
            ],
          ),
          SizedBox(
            width: 800,
