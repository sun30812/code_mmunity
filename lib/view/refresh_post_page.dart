...
/// 게시글 페이지를 강제로 갱신할 때 쓰이는 화면이다.
///
/// 특정 위젯을 보여주는 것이 아닌 강제로 데이터 새로고침이 필요할 때 사용한다. 해당 페이지로
/// 이동을 시킨 경우 포스트화면으로 다시 이동하게 된다.
///
/// {@tool snippet}
///
...
/// - [GoRouter]
///
class RefreshPostPage extends StatelessWidget {
  final int postId;
  const RefreshPostPage({required this.postId, super.key});
